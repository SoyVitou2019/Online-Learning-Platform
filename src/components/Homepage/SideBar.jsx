        ...
        <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div className="h-full w-80 px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-700">
            <a href="#" className="flex items-center ps-2.5 mb-5">
              <i className="bi bi-person-square w-20 text-6xl " style={{ color: 'white' }}></i>
              <div className="flex-col px-3">
                <div className="text-white text-xs">Student</div>
                <span className="text-xl whitespace-nowrap dark:text-white">Eong Koungmeng</span>
                <div className="text-white text-xs">Followers: 15</div>
              </div>
              <i className="bi bi-list text-2xl px-2 align-middle" style={{ color: 'white' }}></i>
            </a>
            <hr></hr>
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-400 bg-blue-100 rounded-full dark:bg-blue-700 dark:text-blue-300">3</span>
                </a>
              </li>
              <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <span className="flex-1 ms-3 whitespace-nowrap">Continue learning</span>
                </a>
              </li>
            </ul>
          </div>

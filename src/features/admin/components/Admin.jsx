            ...
            <div className="">
                ...
                <div className="border-y-2">
                    <div className="flex px-12 items-center py-2 ">
                        <button className="xl:hidden " onClick={() => setShowMenu(e => !e)}>
                            <svg
                                className="w-6 h-6"
                                aria-hidden="true"
                                fill="currentColor"
                        ...
                        <div
                            ref={menuRef}
                            className={`z-10 ${showMenu ? "absolute mt-10 mr-5 xl:hidden" : "hidden"}`}
                        >
                            <div className="origin-top-right absolute mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                        ...
                        <div className=" flex gap-7 pl-16 hidden xl:flex ">
                            <button
                                onClick={() => {
                                    setSearchValue("");
                                    setRoleDisplay("users");

              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <form className="max-w-sm mx-auto mt-5">
                    <label htmlFor="user_id" className="block mb-2 text-sm font-medium text-black">User ID Request</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                        ID
                      </div>
                      <input type="text" id="user_id" value={formData.user_id} name='user_id' onChange={handleChange} aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full ps-10 p-2.5  " pattern="[0-9]{1}" placeholder="1" required />
                    </div>
                    <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">currently is just dummy website.</p>
                  </form>
                  ...
                  <form className="max-w-sm mx-auto mt-5">
                    ...
                    <div className="relative">
                      ...
                      <input type="text" id="phone-input" value={formData.phoneNumber} name='phoneNumber' onChange={handleChange} aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full ps-10 p-2.5  " pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890" required />
                    </div>
                  ...
                  <div className="mt-5">
                    ...
                    ></textarea>
                    <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">The reason should be related to your experience.</p>
                  </div>
